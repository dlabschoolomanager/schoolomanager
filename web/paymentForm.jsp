...
<%
    String apiLoginId = "9USY9w8a33x6";
    String transactionKey = "5d5sb32P3C9GCn2r";
    String relayResponseUrl = "http://localhost:8084/relayResponse.jsp";
    String amount = "1.99";
...
<FORM NAME='secure_redirect_form' ID='secure_redirect_form_id'
 ACTION='https://test.authorize.net/gateway/transact.dll' METHOD='POST'>
  <label>Credit Card Number</label><input type='text' class='text' name='x_card_num' size='15'>
    </input>
