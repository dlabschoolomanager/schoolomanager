       ...
       this.callParent(arguments);
        ...
        if(getPermission(SETTING.Perm.Widget_ALERT.widgetNo)){
            WIDGETS.push(Ext.create('Ext.app.view.portlet.Portlet',{
                ...
                height:240,
                tools: this.getTools(),
                tpl: '<tpl for="rows"><div style="margin :3px 3px 3px 3px;height:32px"><div style="float:left;font-size:9"><span style="float: left"><font color=#17385B><b>Module :</b></font>{m_name}</span><span style="float:right;padding-left:60px"><font color=#17385B><b>Sub :</b></font>{alert_name}</span></div><br><div style="float: left;font-size:9"><font color=#17385B><b>Title :</b></font>{title}</div></div><hr style="height:1px;border-width:0;background-color:#db6800;background: #db6800;width:270px" ></tpl>',
             //   tpl: '<tpl for="rows"><b>{m_name}</b> - <span style="color:#11111">{alert_name}</span><br/><span style="color:#11111">{title}</span><br/><span style="color:#11111">{dsc}</span><br/></tpl>',
                loader: {
                    autoLoad: true,
