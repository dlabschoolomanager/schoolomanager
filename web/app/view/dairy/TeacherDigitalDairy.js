...
Ext.define('MyApp.view.dairy.TeacherDigitalDairy' ,{
    ...
    },
    {
        ...
        style :'color:#17385B;font-weight:bold',
        width:'8%',
        renderer:function(value){return '<input type="button" style="margin-top: 2px;border: none;width:70px;background:green;color:white" value="Reply" onclick=replyToParent("'+value+'")>'}
    },{
        header:'Response',
        dataIndex:'rpid',
        style :'color:#17385B;font-weight:bold',
        width:'8%',
        renderer:function(value){return '<input type="button" style="margin-top: 2px;border: none;width:70px;background:#cc3300;color:white" value="Response" onclick=responseFromParent("'+value+'")>'}
    }
    ];
