...
Ext.define('Ext.calendar.view.AbstractCalendar', {
    ...
    initComponent: function() {
        this.setStartDate(this.startDate || new Date(),true);
    ...
    getTime:function(v){
       return isNaN(v)?v[M.StartDate.name].getTime():v;
    },
    // private
        ...
        this.store.load({
            params: {
                ...
                //if (refresh === true) {
                    me.refresh();
                //}
                me.fireEvent('datechange', this, this.startDate, this.viewStart, this.viewEnd);
            }
        });
