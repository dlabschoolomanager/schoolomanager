...
Ext.define('Ext.calendar.view.Month', {
    ...
    getEventTemplate: function() {
        if (!this.eventTpl) {
            ...
            new Ext.XTemplate(
                '<div id="{_elId}" class="{_selectorCls} {spanCls} ext-cal-evt ext-cal-evr" style="{_colorCls}">',
                    body,
                '</div>'
            )
            : new Ext.XTemplate(
                '<tpl if="_renderAsAllDay">',
                    '<div id="{_elId}" class="{_selectorCls} {spanCls} ext-cal-evt ext-cal-evo" style="{_colorCls}">',
                        '<div class="ext-cal-evm">',
                            '<div class="ext-cal-evi">',
                '</tpl>',
                '<tpl if="!_renderAsAllDay">',
                    '<div id="{_elId}" class="{_selectorCls} ext-cal-evt ext-cal-evr" style="{_colorCls}">',
                '</tpl>',
                    body,
                '<tpl if="_renderAsAllDay">',
                            '</div>',
...
//            _selectorCls: selector,
            _colorCls: 'background:#'+this.calendarStore.getColor(evt[M.CalendarId.name]),//'ext-color-' + (evt[M.CalendarId.name] ? evt[M.CalendarId.name] : 'default') + (evt._renderAsAllDay ? '-ad': ''),
